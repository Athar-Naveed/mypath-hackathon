...
const AgentButton = ({
  ...
  const variants = {
    primary: `
      ...
      active:bg-gradient-to-r active:from-blue-600 active:text-white active:to-blue-700
    ...
    >
      ...
      >
        <div className="flex items-center justify-center gap-2 leading-none">
          <span
            className={`${iconSizes[size]} flex-shrink-0 flex items-center justify-center ${active ? "text-white" : "text-dark-logo-primary dark:text-blue-400"}`}
          >
            {icon}
          </span>
          <span
            className={`inline-flex items-center ${active ? "text-white" : "text-dark-logo-primary dark:text-blue-400"}`}
          >
            {title}
          </span>
        </div>
