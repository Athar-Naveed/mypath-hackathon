...
import {Eye, EyeOff, Mail, Lock, User2Icon, LockKeyhole, ChevronLeft} from "lucide-react";
  ...
  return (
    <div className="flex gap-10 lg:gap-2 mx-2 lg:mx-0 h-screen items-center">
      ...
      <div className="register-form mx-auto lg:mx-5">
        ...
        <Formik
          ...
          onSubmit={async (values) => {
            ...
            try {
              ...
              values.ipAddress = res.data.ip;
              values.city = res.data.city;
              values.country = res.data.country;
            ...
            <Form className="space-y-4 reglo-form lg:my-10">
              <div className="relative">
                <Field
                  ...
                  required
                />
                <User2Icon className="absolute left-3 top-2.5 h-5 w-5 text-dark-custom-blue dark:text-light-light-white" />
              </div>
              <div className="relative">
                <Field
                  type="email"
              ...
              <div className="my-4 relative">
                <User2Icon className="absolute left-3 top-2.5 h-5 w-5 text-dark-custom-blue dark:text-gray-400 z-10" />
                <Field
                  as="select"
                  name="gender"
                  id="gender"
                  className="reglo-input-field py-2 pl-10 " // Add left padding to make room for the icon
                >
                  <option
                    value=""
                    disabled
                    className="text-dark-custom-dark-blue dark:text-gray-400 px-2 bg-white"
                  >
                    Select a Gender
                  </option>
              ...
              <div className="relative">
                ...
                >
                  {showPassword ? (
                    <Eye className="h-5 w-5 text-dark-custom-blue dark:text-light-light-white" />
                  ) : (
                    <EyeOff className="h-5 w-5 text-dark-custom-blue dark:text-light-light-white" />
                  )}
                </button>
              </div>
              <div className="relative">
                <Field
                  ...
                  required
                />
                <LockKeyhole className="absolute left-3 top-2.5 h-5 w-5 text-dark-custom-blue dark:text-light-light-white" />
                <ErrorMessage
                  name="cpassword"
                  component="div"
                  className="text-red-500 text-sm mt-1"
              ...
              <div className="flex items-start gap-2">
                <input
                  ...
                  className="mt-1 h-4 w-4 text-dark-logo-primary focus:ring-dark-logo-primary cursor-pointer border-gray-300 rounded"
                />
                <label
                  htmlFor="terms"
                  className="text-sm text-gray-700 dark:text-light-light-white"
                >
        ...
        <p className="mt-4 text-center text-sm text-dark-custom-dark-blue dark:text-light-light-white">
          Already have an account?{" "}
          <button
            onClick={setReglo}
            className="text-dark-custom-dark-blue font-semibold hover:underline dark:text-light-light-white"
          >
            Login
          </button>
        </p>
